...
namespace ProcessSchedulingSimulation {
	...
	/// <summary>
	/// Summary for ShortestRemainingTimeFirst
	/// </summary>
	public ref class ShortestRemainingTimeFirst : public System::Windows::Forms::Form
	{
		public:
			...
			ShortestRemainingTimeFirst(int noOfProcesses, DynamicSafeArray<Process>& processArrayArg);
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(ShortestRemainingTimeFirst::typeid));
			...
			this->label4->Location = System::Drawing::Point(141, 40);
			...
			this->simSpeedBox->Location = System::Drawing::Point(239, 37);
			...
			this->label3->Location = System::Drawing::Point(141, 131);
			...
			this->exitBtn->Location = System::Drawing::Point(4, 88);
			this->exitBtn->Name = L"exitBtn";
			this->exitBtn->Size = System::Drawing::Size(117, 32);
			...
			this->exitBtn->Click += gcnew System::EventHandler(this, &ShortestRemainingTimeFirst::exitBtn_Click);
			// 
			// startBtn
			// 
			...
			this->startBtn->Location = System::Drawing::Point(5, 8);
			...
			this->startBtn->Click += gcnew System::EventHandler(this, &ShortestRemainingTimeFirst::startBtn_Click);
			// 
			// progressBar1
			// 
			this->progressBar1->Location = System::Drawing::Point(139, 92);
			...
			// PIDTxt
			// 
			this->PIDTxt->Location = System::Drawing::Point(303, 64);
			...
			this->label2->Location = System::Drawing::Point(141, 68);
			...
			this->listView2->Location = System::Drawing::Point(138, 401);
			...
			this->listView1->Location = System::Drawing::Point(138, 147);
			...
			this->listBox1->Location = System::Drawing::Point(5, 148);
			...
			this->label1->Location = System::Drawing::Point(17, 132);
			...
			this->stopBtn->Location = System::Drawing::Point(5, 50);
			this->stopBtn->Name = L"stopBtn";
			this->stopBtn->Size = System::Drawing::Size(116, 32);
			...
			this->stopBtn->Click += gcnew System::EventHandler(this, &ShortestRemainingTimeFirst::stopBtn_Click);
			// 
			// ShortestRemainingTimeFirst
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(959, 483);
			...
			this->Name = L"ShortestRemainingTimeFirst";
			this->ShowIcon = false;
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterParent;
			this->Text = L"Shortest Remaining Time First Simulation";
			this->Load += gcnew System::EventHandler(this, &ShortestRemainingTimeFirst::ShortestRemainingTimeFirst_Load);
...
private: System::Void ShortestRemainingTimeFirst_Load(System::Object^  sender, System::EventArgs^  e) {
			 updateReadyQueue();
		 }
private: System::Void startBtn_Click(System::Object^  sender, System::EventArgs^  e) {
			 	if(simSpeedBox->SelectedIndex > -1){
					...
					simulationSpeed = 100;
				ThreadStart^ start = gcnew ThreadStart(this, &ShortestRemainingTimeFirst::simulateExecution);
